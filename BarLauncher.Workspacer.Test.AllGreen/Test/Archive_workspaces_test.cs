...
namespace BarLauncher.Workspacer.Test.AllGreen.Test
{
    public class Archive_workspaces_test : TestBase<WorkspacerContext>
    {
        public override void DoTest() =>
            ...
            .UsingList<Bar_launcher_results_fixture>()
            .With<Bar_launcher_results_fixture.Result>(f => f.Title, f => f.SubTitle)
            .Check("archive data [PATTERN] [PATTERN]", "Archive a workspace in the data repo")
            .Check("archive erk [PATTERN] [PATTERN]", "Archive a workspace in the erk repo")
            .EndUsing()
            ...
            .UsingList<Bar_launcher_results_fixture>()
            .With<Bar_launcher_results_fixture.Result>(f => f.Title, f => f.SubTitle)
            .Check("archive data 2014-07-29-this_item_contains_the_word_shrubbery", "Archive 2014-07-29-this_item_contains_the_word_shrubbery")
            .Check("archive data 2014-08-07-ruby", "Archive 2014-08-07-ruby")
            .EndUsing()
            ...
            .UsingList<Bar_launcher_results_fixture>()
            .With<Bar_launcher_results_fixture.Result>(f => f.Title, f => f.SubTitle)
            .Check("cd data 0__ARCHIVE__", "Go to 0__ARCHIVE__")
            .Check("cd data 2014-07-12-another_task", "Go to 2014-07-12-another_task")
            .Check("cd data 2014-07-12-task_1", "Go to 2014-07-12-task_1")
            .Check("cd data 2014-07-19-new_task", "Go to 2014-07-19-new_task")
            .Check("cd data 2014-08-07-ruby", "Go to 2014-08-07-ruby")
